...
experiment_name = 'task_1_test_GA'
...
file_aux.write('\n\ngen best mean std')
print('\n GENERATION '+str(ini_g)+' Fitnesses (best/mean/std): '+str(round(fit_pop[best],6))+'/'+str(round(mean,6))+'/'+str(round(std,6)))
...
for i in range(ini_g+1, gens):
    ...
    # saves results
    file_aux  = open(experiment_name+'/results.txt','a')
    print('\n GENERATION '+str(i)+' Fitnesses (best/mean/std): '+str(round(fit_pop[best],6))+'/'+str(round(mean,6))+'/'+str(round(std,6)))
